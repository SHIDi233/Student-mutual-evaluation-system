<template>
  <div>
    ...
    <el-button type="primary"  @click="drawer = true " :loading="loading" :disabled="b">新建班级</el-button>
    <el-table
      :data="tableData"
      border
      style="width: 100%">
    ...
    <el-drawer
      ...
      <el-button type="primary" @click="Click()" :loading="bc" >创建</el-button>
    </el-drawer>
    <el-drawer
      title="加入页"
      ...
      <el-button type="primary" @click="Click_2()" :loading="bc_2" :disabled="b_2" >加入</el-button>
    </el-drawer>
  </div>
